/*
 Write a program to create a single linked list and perform insert at first, insert at last, insert any position, delete first, delete last delete from any
 position and display operation on it.
 */
