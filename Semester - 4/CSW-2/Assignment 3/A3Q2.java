/*
 Write a program that performs base conversion. The input is a string, an integer b2 , and another integer b2. The string represents be an integer in base b2. 
